...
Critical patterns for working with SharePoint Online from a Microsoft App. **Read this before writing any SharePoint code.**
...
// item.AssignedTo = { Id: 15, Value: "user@contoso.com" }
